...
class CitiesSearchAdapter : RecyclerView.Adapter<CitiesSearchAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CitiesSearchAdapter.ViewHolder {
        val binding = CitiesSearchItemBinding
            .inflate(LayoutInflater.from(parent.context), parent, false)
        return ViewHolder(binding)
    }

    override fun onBindViewHolder(holder: CitiesSearchAdapter.ViewHolder, position: Int) {
